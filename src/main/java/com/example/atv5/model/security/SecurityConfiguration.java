...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        .requestMatchers("produtos/form", "pessoa/list", "produtos/list").hasAnyRole("ADMIN")
                                        .requestMatchers(HttpMethod.POST).permitAll()
                                        .requestMatchers("/usuario/form","/usuario/save", "pessoaFisica/form", "pessoaJuridica/form").permitAll()
                ...
                .formLogin(customizer ->
                        customizer
                                ...
                                .defaultSuccessUrl("/produtos/compraProdutos", true)
